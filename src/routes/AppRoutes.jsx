...
import { SellerDashboard, SellerProducts, SellerOrders } from '../pages/seller/SellerPages';
import { AdminDashboard, AdminUsers, AdminProducts, AdminCategories, AdminOrders, AdminCoupons } from '../pages/admin/AdminPages';
